# -*- encoding: utf-8 -*-
# stub: terminal-notifier 1.7.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.homepage = "https://github.com/alloy/terminal-notifier".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "2.5.2".freeze
  s.summary = "Send User Notifications on Mac OS X 10.8 or higher.".freeze
